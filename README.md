...
This is a verilog implementation of the FrodoKEM algorithm, for a paper submitted to LightSEC 2025: https://doi.org/10.1007/978-3-032-15541-2_6.

It has a single module (in src/main.v) that can be configured to run the three FrodoKEM schemes FrodoKEM-{640,976,1344}-SHAKE. More specifically, the module can be configured to run any of the three algorithms of FrodoKEM: Key generation, encapsulation and decapsulation. It executes those algorithms one at a time. See the related paper for more information on the FrodoKEM algorithm and on the implementation structure.
